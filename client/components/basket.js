        ...
        .map((it) => {
          return (
            <div key={it.id} className="card p-2">
              <div className="product__title card__title">{it.title}</div>
              <div>
              ...
              <div className="flex items-center">
                <div>
                  <button
                    ...
                    className="card__button mr-5 product__remove"
                    type="button"
                  >
                    -
                  </button>
                </div>
                <div className="bg-teal-200 product__amout  mr-5">{cart[it.id]}</div>
                <div>
                  <button
                    onClick={() => dispatch(addAmount(cart, it.id, amount, price, it.price))}
                    className="card__button mr-5"
                    type="button"
                  >
                    +
                  </button>
